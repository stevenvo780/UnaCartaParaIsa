/**
 * Catálogo de misiones con textos estilo RPG
 * Cada misión tiene narrativa completa y objetivos claros
 */
...
export class QuestCatalog {
      ...
      objectives: [
        {
          ...
          description: 'Recolecta ingredientes para preparar una comida especial',
          requiredAmount: 3,
          currentAmount: 0,
          isCompleted: false,
          isOptional: false,
  ...
  /**
   * Obtiene misiones repetibles (diarias, etc.)
   */
