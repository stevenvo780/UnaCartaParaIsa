...
export class RegistryValidator {
   ...
   */
    public static validateGameState(
        ...
        const sanitizedData: GameState = {
            ...
            worldConfig: this.sanitizeObject(data.worldConfig),
   ...
   */
    private static validateSingleZone(
        ...
        const color = this.sanitizeNumber(zone.color, 0, 0xffffff);
        ...
        const sanitizedZone: Zone = {
            ...
            description: this.sanitizeString(zone.description),
            position: positionResult.sanitizedData || { x: 0, y: 0 },
            size: sizeResult.sanitizedData || { width: 32, height: 32 },
            color: color,
            ...
            benefits: this.sanitizeBenefits(zone.benefits),
        };
