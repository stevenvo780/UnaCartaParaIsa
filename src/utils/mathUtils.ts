 ...
 */
export function worldToGrid(x: number, y: number, gridSize: number): { x: number; y: number } {
    return {
 ...
 */
export function positionToTile(position: { x: number; y: number }, tileSize: number): { x: number; y: number } {
