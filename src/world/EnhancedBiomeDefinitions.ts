...
export const ENHANCED_BIOME_FEATURES: Record<BiomeType, EnhancedBiomeFeatures> = {
  [BiomeType.GRASSLAND]: {
    ruins: {
      types: ['sand_ruins1.png', 'sand_ruins2.png', 'brown_ruins1.png', 'brown_ruins2.png'],
      density: 0.05,
      spacing: 8,
    },
    structures: {
  ...
  [BiomeType.MOUNTAINOUS]: {
    ruins: {
      types: ['snow_ruins1.png', 'snow_ruins2.png', 'white_ruins1.png', 'white_ruins2.png', 'white_ruins3.png'],
      density: 0.15,
      spacing: 3,
    },
    structures: {
 ...
 */
export function getEnhancedBiomeFeatures(biome: BiomeType): EnhancedBiomeFeatures {
 ...
 */
export function getFullBiomeDefinition(biome: BiomeType): BiomeDefinition & { enhanced: EnhancedBiomeFeatures } {
  return {
...
export function calculateBiomeDensity(biome: BiomeType): number {
  ...
  if (features.specialFeatures) {
    totalDensity += features.specialFeatures.reduce((sum, feature) => sum + feature.density, 0);
  }
...
export function getAllRequiredAssets(): string[] {
  ...
  Object.values(ENHANCED_BIOME_FEATURES).forEach(features => {
    ...
    features.specialFeatures?.forEach(feature => feature.assets.forEach(asset => assets.add(asset)));
  });
...
export function getWildlifeSpawnConfig(biome: BiomeType): {
  ...
  return {
    ...
    totalSpawnChance: features.wildlife.density * features.wildlife.spawnProbability,
  };
}
