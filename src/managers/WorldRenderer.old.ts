...
export class WorldRenderer {
  ...
  constructor(scene: Phaser.Scene, gameState: GameState) {
    ...
    // Initialize EntityRenderer with animation manager
    this.entityRenderer = new EntityRenderer(scene, this.animationManager);
  ...
  private renderWorldEntity(entity: WorldEntity, zoneName?: string): void {
    ...
    if (renderedEntity) {
      ...
      this.decorationSprites.push(renderedEntity as any);
    } else {
      // Fallback to old method if EntityRenderer fails
